...
import { TableHeadComponent } from 'src/app/shared/layouts-league/mft/table-head/table-head.component';
import { TableMenuComponent } from 'src/app/shared/layouts-league/mft/table-menu/table-menu.component';
